...
base_power_5g = 4000 - base_power_iperf
...
Predict_y_OLS_test = Predict_y_OLS_test-1600
Predict_y_OLS_test[Predict_y_OLS_test<0] = 2200




Predict_y_OLS_test_CPU = Test_X[:,:3].dot(w[:3,0].reshape(3,1))+750-300
Predict_y_OLS_test_tramsceiver = Test_X[:,3:].dot(w[3:,0].reshape(3,1))+2200-750
