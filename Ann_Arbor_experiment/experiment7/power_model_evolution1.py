...
# w = np.array([2.068521908322784100e+02,
# 2.767647038029738269e+02*6,
# 4.091669356203735219e+02,
# 1.167907497140207917e+00,
# 1.120591312076107613e+02,])
...
Predict_y_OLS_test_CPU = Test_X[:,:3].dot(w[:3,0].reshape(3,1))+750-300
