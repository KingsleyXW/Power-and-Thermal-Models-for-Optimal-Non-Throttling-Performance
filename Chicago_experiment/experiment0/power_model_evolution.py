...
# X_for_pretest = np.concatenate((average_CPU_T_test.reshape(1, N_test), time_stamp_test.reshape(1, N_test)),0)
# power_pretest = func(X_for_pretest, 1.58727284e-02,  2.65738865e+00, -1.77107918e+01)
# power_pretest = power_pretest.reshape(N_test, -1)
