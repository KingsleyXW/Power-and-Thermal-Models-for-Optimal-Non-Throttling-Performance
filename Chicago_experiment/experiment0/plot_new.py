...
# plt.legend(['Current_skin_T','Average_CPU_T','Threshold 43 ($^o C$)', 'Threshold 45 ($^o C$)'], loc=4)
...
plt.legend(['Current_skin_T','Threshold 43 ($^o C$)', 'Threshold 45 ($^o C$)'], loc=3)
plt.ylim(10, 55)
...
# stress transceiver
# time_stamp_start = 1657232795627
# time_stamp_nsg_start = int(1657232817.931 * 1000)
# time_stamp_nsg_stop = int(1657233117 *1000)
# deviation =  time_stamp_nsg_start-time_stamp_start
# print(deviation)
# time_stamp_point1 = 1657233055 *1000
