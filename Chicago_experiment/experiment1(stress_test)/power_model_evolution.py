...
# from power_model_nonlinear import func as func
...
def data_prepocessing(data):
    ...
    for key, value in data.items():
        ...
        # current_CPU_0_usage.append(current_CPU_U[0])
        # current_CPU_1_usage.append(current_CPU_U[1])
        # current_CPU_2_usage.append(current_CPU_U[2])
        # current_CPU_3_usage.append(current_CPU_U[3])
        # current_CPU_4_usage.append(current_CPU_U[4])
        # current_CPU_5_usage.append(current_CPU_U[5])
        # current_CPU_6_usage.append(current_CPU_U[6])
        # current_CPU_7_usage.append(current_CPU_U[7])
    ...
    # average_CPU_T[1:-1] = average_CPU_T[1:-1] - average_CPU_T[0:-2]
    # average_CPU_T[0] = 0
...
# CPU_0_average_U, CPU_1_average_U, CPU_2_average_U,CPU_3_average_U,CPU_4_average_U,CPU_5_average_U =\

# plt.figure(0)
# plt.plot(time_stamp, WEDC[:,0], marker="o", markersize=5,)
# plt.plot(time_stamp, WEDC[:,1], marker="o", markersize=5)
# plt.plot(time_stamp, WEDC[:,2], marker="o", markersize=5)
# plt.xlabel("Elapsed Time (s)", fontsize=10)
# plt.ylabel("WEDC", fontsize=10)
# plt.legend(['CPU0 state1 WEDC', 'CPU0 state2 WEDC', 'CPU0 state3 WEDC'])
# plt.title('CPU 0 WEDC')
...
plt.legend(['CPU0 state1 WEDC', 'CPU0 state2 WEDC', 'CPU0 state3 WEDC'])
plt.subplot(232)
plt.plot(time_stamp, WEDC[:,3], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,4], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,5], marker="o", markersize=5)
plt.xlabel("Elapsed Time (s)")
plt.title('CPU 0~5 WEDC')

plt.legend(['CPU1 state1 WEDC', 'CPU1 state2 WEDC', 'CPU1 state3 WEDC'])
plt.subplot(233)
plt.plot(time_stamp, WEDC[:,6], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,7], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,8], marker="o", markersize=5)
plt.xlabel("Elapsed Time (s)")
plt.ylabel("Weighted Average Duration(WEDC)")
# plt.title('CPU 2 WEDC')
plt.legend(['CPU2 state1 WEDC', 'CPU2 state2 WEDC', 'CPU2 state3 WEDC'])

plt.subplot(234)
plt.plot(time_stamp, WEDC[:,9], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,10], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,11], marker="o", markersize=5)
plt.legend(['CPU3 state1 WEDC', 'CPU3 state2 WEDC', 'CPU3 state3 WEDC'])
plt.xlabel("Elapsed Time (s)")
plt.ylabel("WEDC", fontsize=10)
plt.subplot(235)
plt.plot(time_stamp, WEDC[:,12], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,13], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,14], marker="o", markersize=5)
plt.xlabel("Elapsed Time (s)")

plt.legend(['CPU4 state1 WEDC', 'CPU4 state2 WEDC', 'CPU4 state3 WEDC'])
plt.subplot(236)
plt.plot(time_stamp, WEDC[:,15], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,16], marker="o", markersize=5)
plt.plot(time_stamp, WEDC[:,17], marker="o", markersize=5)
plt.xlabel("Elapsed Time (s)")

plt.legend(['CPU5 state1 WEDC', 'CPU5 state2 WEDC', 'CPU5 state3 WEDC'])

# plt.figure(0)
# plt.plot(time_stamp[0:1000], power_original[0:1000], marker="o", markersize=5)
# plt.plot(time_stamp[0:1000], power[0:1000], marker="o", markersize=5)
# plt.legend(['Power Original', 'Power Smoothed'])


SETTING_CONDITION = 4 # 0,1,2,3,4
...
if SETTING_CONDITION == 0:
    ...
    X_train = np.array([Total_utilization.reshape(N_train,-1), CPU_0_average_U.reshape(N_train,-1), CPU_1_average_U.reshape(N_train,-1), CPU_2_average_U.reshape(N_train,-1), CPU_3_average_U.reshape(N_train,-1),
                        ...
                        np.ones((N_train,1))])
    X_train = np.array([Total_utilization.reshape(N_train,-1), CPU_6_average_U.reshape(N_train,-1), CPU_7_average_U.reshape(N_train,-1),channe_number.reshape(N_train,1),
                        np.ones((N_train,1))])
    ...
    # X_train = np.array([Total_utilization.reshape(N_train,-1),
    #                     CPU_6_average_U.reshape(N_train,-1), CPU_7_average_U.reshape(N_train,-1), np.ones((N_train,1))])
    # X_train = np.array([CPU_0_average_U.reshape(N_train,-1), CPU_1_average_U.reshape(N_train,-1), CPU_2_average_U.reshape(N_train,-1),CPU_3_average_U.reshape(N_train,-1),
    #                     CPU_4_average_U.reshape(N_train,-1), CPU_5_average_U.reshape(N_train,-1), CPU_6_average_U.reshape(N_train,-1), CPU_7_average_U.reshape(N_train,-1),
    #                     average_CPU_T.reshape(N_train,-1), np.ones((N_train,1))]) #average_CPU_T.reshape(N_train,-1),
    # X_train = np.array([CPU_0_average_U.reshape(N_train,-1), CPU_1_average_U.reshape(N_train,-1), CPU_2_average_U.reshape(N_train,-1),CPU_3_average_U.reshape(N_train,-1),
    #                     CPU_4_average_U.reshape(N_train,-1), CPU_5_average_U.reshape(N_train,-1), average_CPU_T.reshape(N_train,-1), np.ones((N_train,1))]) #average_CPU_T.reshape(N_train,-1),
...
if SETTING_CONDITION == 0:
    ...
    X_test = np.array([Total_utilization_test.reshape(N_test,-1),CPU_0_average_U_test.reshape(N_test,-1), CPU_1_average_U_test.reshape(N_test,-1), CPU_2_average_U_test.reshape(N_test,-1),CPU_3_average_U_test.reshape(N_test,-1),
                       ...
                       np.ones((N_test,1))])
    X_test = np.array([Total_utilization_test.reshape(N_test,-1), CPU_6_average_U_test.reshape(N_test,-1), CPU_7_average_U_test.reshape(N_test,-1), channe_number_test.reshape(N_test,-1), channe_number_test.reshape(N_test,-1),
                       np.ones((N_test,1))])
elif SETTING_CONDITION == 3 or SETTING_CONDITION == 4:
    X_test = np.array([Total_utilization_test.reshape(N_test,-1), 
                        CPU_6_average_U_test.reshape(N_test,-1), CPU_7_average_U_test.reshape(N_test,-1), average_CPU_T_test.reshape(N_test,-1),channe_number_test.reshape(N_test,-1),np.ones((N_test,1))])
    # X_test = np.array([Total_utilization_test.reshape(N_test,-1), 
    #                     CPU_6_average_U_test.reshape(N_test,-1), CPU_7_average_U_test.reshape(N_test,-1), np.ones((N_test,1))])
    # X_test = np.array([CPU_0_average_U_test.reshape(N_test,-1), CPU_1_average_U_test.reshape(N_test,-1), CPU_2_average_U_test.reshape(N_test,-1),CPU_3_average_U_test.reshape(N_test,-1),
    #                    CPU_4_average_U_test.reshape(N_test,-1), CPU_5_average_U_test.reshape(N_test,-1), CPU_6_average_U_test.reshape(N_test,-1), CPU_7_average_U_test.reshape(N_test,-1), 
    #                    average_CPU_T_test.reshape(N_test,-1), np.ones((N_test,1))])#average_CPU_T_test.reshape(N_test,-1), 
    # X_test = np.array([CPU_0_average_U_test.reshape(N_test,-1), CPU_1_average_U_test.reshape(N_test,-1), CPU_2_average_U_test.reshape(N_test,-1),CPU_3_average_U_test.reshape(N_test,-1),
    #                    CPU_4_average_U_test.reshape(N_test,-1), CPU_5_average_U_test.reshape(N_test,-1), average_CPU_T_test.reshape(N_test,-1), np.ones((N_test,1))])
...
MS_tr=np.sum(1-np.abs(train_y-Predict_y_OLS)/train_y)
