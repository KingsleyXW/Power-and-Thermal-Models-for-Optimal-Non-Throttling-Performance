...
if SETTING_CONDITION == 0:
    ...
    X_train = np.array([Total_utilization.reshape(N_train,-1),
                        CPU_6_average_U.reshape(N_train,-1), CPU_7_average_U.reshape(N_train,-1), Current_skin_T.reshape(N_train,-1), downlink.reshape(N_train,-1)])
    # X_train = np.array([
    #                     average_CPU_T.reshape(N_train,-1)])
...
if SETTING_CONDITION == 3:
    ...
    #  X_test = np.array([
    #                     average_CPU_T_test.reshape(N_test,-1)])
